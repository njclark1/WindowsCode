...

{
 ...
 //cout ,getline(cin moviename );
    ...
    //display results "cls"
    cout << "Gross Revenue  $" << (adultTickets * ADULT_TICKET) + (childTickets * CHILD_TICKET) << endl << endl;



    cout << "Dist Paid $" << grossBox * .20 << endl << endl;



    cout << "Net Revenue $" << grossBox - distPaid << endl << endl;
