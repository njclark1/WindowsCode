...
public class MainActivity5 extends AppCompatActivity {
    ...
    private EditText percentageOfGrade5;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pointsPossible1 = (EditText) findViewById(R.id.editTextNumber4);
        pointsPossible2 = (EditText) findViewById(R.id.editTextNumber5);
        pointsPossible3 = (EditText) findViewById(R.id.editTextNumber6);
        pointsPossible4 = (EditText) findViewById(R.id.editTextNumber7);
        pointsPossible5 = (EditText) findViewById(R.id.editTextNumber8);
        pointsEarned1 = (EditText) findViewById(R.id.editTextNumberDecimal7);
        pointsEarned2 = (EditText) findViewById(R.id.editTextNumberDecimal8);
        pointsEarned3 = (EditText) findViewById(R.id.editTextNumberDecimal9);
        pointsEarned4 = (EditText) findViewById(R.id.editTextNumberDecimal10);
        pointsEarned5 = (EditText) findViewById(R.id.editTextNumberDecimal11);
        percentageOfGrade1 = (EditText) findViewById(R.id.editTextNumberDecimal12);
        percentageOfGrade2 = (EditText) findViewById(R.id.editTextNumberDecimal13);
        percentageOfGrade3 = (EditText) findViewById(R.id.editTextNumberDecimal14);
        percentageOfGrade4 = (EditText) findViewById(R.id.editTextNumberDecimal15);
        percentageOfGrade5 = (EditText) findViewById(R.id.editTextNumberDecimal16);
        resultView = (TextView) findViewById(R.id.resultView4);
        encourageView = (TextView) findViewById(R.id.textView39);
        calcButton = findViewById(R.id.button8);
        ...
        calcButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                double pp5 = Double.parseDouble(pointsPossible5.getText().toString());
                ...
                double pe5 = Double.parseDouble(pointsEarned5.getText().toString());
                ...
                double percent5 = Double.parseDouble(percentageOfGrade5.getText().toString());
                ...
                double type5Percentage = (pe5/pp5);
                ...
                double type5PointsEarned = type5Percentage * (percent5);

                //total points earned
                double totalPointsEarned = type1PointsEarned + type2PointsEarned + type3PointsEarned + type4PointsEarned + type5PointsEarned;
